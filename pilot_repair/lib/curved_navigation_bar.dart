import 'dart:math';
import 'package:pilot_repair/src/nav_custom_clipper.dart';
...
class CurvedNavigationBar extends StatefulWidget {
  ...
  final Color backgroundColor; // <-- Make sure to use transparent color here
  ...
  CurvedNavigationBar({
    ...
    this.backgroundColor = const Color.fromARGB(0, 59, 18, 18), // <-- Default to transparent
    this.onTap,
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return Align(
            ...
            child: Container(
              color: Colors.transparent, // Ensure this is transparent
              width: maxWidth,
              child: ClipRect(
